...
- Login to [artifactory](https://iadvize.jfrog.io/iadvize/webapp/). Ask your own swarm Lead Developer if you don't have an access.
...
//iadvize.jfrog.io/iadvize/api/npm/iadvize-npm/:_password=an-awesome-and-secure-password-lol
